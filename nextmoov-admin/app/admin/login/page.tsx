    ...
    <div className="min-h-screen flex items-center justify-center bg-[#00020e]">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <div className="inline-block text-white font-black text-2xl uppercase" style={{ letterSpacing: '4px' }}>
            NEXT<span style={{ color: '#B22234' }}>MOOV</span>
            <span style={{ color: '#C0A060', fontSize: '0.65em', display: 'block', letterSpacing: '6px', marginTop: '2px' }}>USA · ADMIN</span>
          </div>
        </div>
        <div className="bg-[#020b4a] border border-white/10 rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            {error && <p className="text-[#B22234] text-xs text-center">{error}</p>}
